...
app.include_router(api_router)  # Direct root fallback
app.include_router(api_router, prefix="/api/v")  # Typo fallback
app.include_router(api_router, prefix="/api/v/api/v1")  # Nested typo fallback
