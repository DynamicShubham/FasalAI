...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BENCH_corn_rust` | A. Benchmark Disease Image | corn_rust.jpg | None (Auto) | Corn (Maize) - Common Rust (High Conf) | Corn (Maize) - Common Rust (Corn Common Rust (Puccinia sorghi)) | 1.0000 (100%) | **PASS** | Correct pathology top-1. Clean uninflated probability. |
