...
| `BENCH_potato_blight` | A. Benchmark Disease Image | potato_blight.jpg | None (Auto) | Potato - Late Blight (Moderate Conf) | Potato - Late Blight (Potato Late Blight (Phytophthora infestans)) | 0.6380 (63%) | **PASS** | Correct pathology top-1. Clean uninflated probability. |
